...
export type ClientOptions = {
  baseUrl:
    ...
    | 'https://api.betanet.nf.domains'
    | 'http://localhost:80'
    | (string & {})
}

/**
 * Asset contains basic information about an asset (Fungible or Non-Fungible)
 */
export type Asset = {
  /**
   * amounts of the asset for any accounts it was found in (depending on filters)
   */
  amounts: Array<AssetAmounts>
  /**
   * An Algorand Account address
   */
  creator: string
  /**
   * Number of decimal places for the ASA
   */
  decimals: number
  /**
   * ASA ID
  ...
  id: number
  /**
   * URL of image w/in metatadata, if different to url
   */
  imageUrl: string
  name: string
  /**
   * Total number of units created for this ASA
   */
  totalCreated: number
  unitName: string
  /**
...
/**
 * AssetAmounts specifies an account and amount contained for that account
 */
...
/**
 * Collection of Bluesky records
 */
export type BlueskyRecords = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
   ...
   */
  'match-check'?: string
  results: Array<BlueskyRecord>
}

/**
 * Collection of Consensus metrics data
 */
export type ConsensusMetricsData = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
...
/**
 * Collection of Consensus records
 */
export type ConsensusRecords = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
...
/**
 * An event the client wants to distribute to other users
 */
...
/**
 * Notification of a control event - ie, user is typing something, etc.
 */
...
export type ConversationEvent = {
  id: string
  /**
   * changes active conversation to conversationId
   */
  setActive?: boolean
  /**
   * message id of last seen message in specified conversation
   */
  setLastSeen?: string
  /**
   * sender is typing in the active (specified) conversation
   */
  typing?: boolean
}
...
export type ConversationNotification = {
  ...
  id: string
  /**
   * indicates user has been removed from this conversation (likely lost permissions because of nfd being sold)
   */
  removedFromConversation?: boolean
  typingEvent?: ConversationTypingEvent
}

export type ConversationState = {
  /**
   * ID of last seen message in this conversation
   */
  lastSeenId?: string
}
...
/**
 * Direct Message Response in ack data event
 */
export type DmDataResp = {
  conversationId: string
  id: string
}
...
export type DmConversations = {
   ...
   */
  'cache-control'?: string
  conversations: Array<DmWithState>
  /**
   * ETag
   */
  etag?: string
...
export type ErrorResponse = {
  ...
  message?: string
  /**
   * if rate-limited error, seconds remaining until rate limit expires
   */
...
export type GetQuoteResponseBody = {
  ...
  exists: boolean
  /**
   * extra needed to cover MBR if linking address on mint
   */
  extraCarryIfLinkOnMint: number
  /**
...
export type MintRequestBody = {
  ...
  buyer: string
  /**
   * Whether the buyer address (must also be owner!) should be automatically linked to the NFD upon minting
   */
  linkOnMint?: boolean
  name: string
  /**
...
/**
 * Collection of NFD activity records
 */
export type NfdActivityRecords = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
...
/**
 * Collection of NFD analytic records
 */
...
export type NfdAnalyticRecords2 = {
  /**
   * Not returned, used in tagging for response to indicate if-none-match etag matched
   */
  'match-check'?: string
...
export type NfdAuctionAndPrice = {
  auctionInfo: NfdAuction
  /**
...
/**
 * Collection of NFD badge records
 */
export type NfdBadges = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
...
/**
 * NFDMarketInfo contains price, category information from backend to provide pricing and type data to public api / user
 */
export type NfdMarketInfo = {
  /**
   * Category of NFD
   */
  category: 'curated' | 'premium' | 'common'
  /**
   * Sell price in microAlgos
   */
  price: number
  /**
   * Sale type of NFD
...
/**
 * NFT contains basic information that a gallery viewer can use when displaying NFTs for the user to choose from
 */
export type Nft = {
  /**
   * Amount
...
/**
 * Collection of NFT records
 */
export type NftRecords = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
...
/**
 * Collection of Linked Address and NFD results
 */
export type NfdLookupRecords = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
...
/**
 * Collection of NFD results
 */
export type NfdRecords = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
 ...
 * Collection of Linked Address and NFD results
 */
export type NfdV2AddressRecords = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
...
export type Participant = {
  activeNFD?: UserActiveNfd
  algoAccount: string
  uid: string
}

export type PostDmEvent = {
  /**
   * array of media ids to attach to message
   */
...
export type PostReactionEvent = {
  conversationId: string
  /**
   * message id to add/update reaction on
   */
  id: string
  /**
   * emoji to add as reaction - set as blank to remove reaction
   */
  reaction: string
}

export type PostRoomPostEvent = {
  /**
   * array of media ids to attach to message
   */
  attachments?: Array<string>
...
/**
 * Reaction Response in ack data event
 */
export type ReactionDataResp = {
  conversationId: string
  reactionToId: string
}
...
export type RoomConversations = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
  conversations: Array<RoomPostWithState>
  /**
   * ETag
   */
  etag?: string
...
/**
 * Room Post Response in ack data event
 */
export type RoomPostDataResp = {
  conversationId: string
  id: string
}

export type RoomPostWithState = {
...
export type StreamingCmdAck = {
  data?: StreamingDataResponse
  /**
   * Request ID from event this ack corresponds to
   */
  requestId: string
}

export type StreamingDataResponse = {
  conversation?: ConversationEvent
  dm?: DmDataResp
  error?: ErrorResponse
  reaction?: ReactionDataResp
}

export type StreamingDataRoomPostResponse = {
  conversation?: ConversationEvent
  error?: ErrorResponse
  post?: RoomPostDataResp
  reaction?: ReactionDataResp
}

export type StreamingDmEvent = {
  control?: ControlEvent
  dm?: PostDmEvent
  reaction?: PostReactionEvent
  /**
   * ID for this event, returned in errors if this request fails
   */
  requestId: string
}

export type StreamingDmEventResponse = {
  ack?: StreamingCmdAck
...
export type StreamingRoomPostCmdAck = {
  data?: StreamingDataRoomPostResponse
  /**
   * Request ID from event this ack corresponds to
   */
  requestId: string
...
export type StreamingRoomPostEvent = {
  control?: ControlEvent
  post?: PostRoomPostEvent
  reaction?: PostReactionEvent
  /**
   * ID for this event, returned in errors if this request fails
   */
...
export type StreamingRoomPostEventResponse = {
  ack?: StreamingRoomPostCmdAck
  control?: ControlNotification
  post?: RoomPost
  reaction?: Reaction
}
...
/**
 * Collection of Twitter records
 */
export type TwitterRecords = {
  /**
   * Cache-Control header
   */
  'cache-control'?: string
   ...
   */
  'match-check'?: string
  results: Array<TwitterRecord>
}

export type UnlinkAddressRequestBody = {
  /**
   * Address(es) to unlink from the NFD (must be able to sign for it)
   */
  address: Array<string>
  /**
   * Address that will be signing the returned transactions.  Should be owner of NFD
...
export type VerifyRequest = {
  /**
   * The data to use as a challenge, specific ot each type.  The UI will provide instructions
   */
  challenge?: string
  /**
   * Array of unsigned and/or signed grouped transactions to sign/submit prior to verification being allowed
   */
  transactions?: string
}
